(function(){
    ...
    function validateConfig(){
        ...
        if(!logger.config.type){
            ...
            throw new Error("'path' property not set, A valid file path should be added to the config object.");
        }
            ...
            throw new Error("'application' property not set, All log entries shold be mapped to an 'application.' Since multiple apps could potentially log to the same file.");
        }
