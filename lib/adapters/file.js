...
function write(type, category, messages){
    return BB.bind(this)
        ...
        .then(this.createEntry(type, category, messages))
        .then(this.writeLog)
        .catch(function(err){
            console.log('\n\nERROR: Could not write to file log.\n\n');
...
function writeLog(entries){
    ...
    return fs.appendFileAsync(this.config.path, output);
}
